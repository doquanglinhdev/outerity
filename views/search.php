                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pd5  ">
                        <ol class="breadcrumb breadcrumb-arrows" itemscope itemtype="http://schema.org/BreadcrumbList">
                            ...
                            <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                                <span itemprop="item" content=""><span itemprop="name"><?php if(isset($namecate)){echo $namecate['ten_loai'];} ?></span></span>
                                                            ...
                                                            <ul class="tree-menu">
                                                                ...
                                                                <li class="tree-menu-lv1 has-child  menu-uncollap ">
                                                                    ...
                                                                    <ul class="tree-menu-sub">
                                                                        ...
                                                                        <li>
                                                                            <span></span>
                                                                            <a href="/collections/tee-1" title="TEE">TEE</a>
                                                                        </li>
                                                                        ...
                                                                        <li>
                                                                            <span></span>
                                                                            <a href="/collections/croptop" title="CROPTOP">CROPTOP</a>
                                                                        </li>

                                                                        <li>
                                                                            <span></span>
                                                                            <a href="/collections/tee" title="HOODIE & SWEATER">HOODIE & SWEATER</a>
                                                                        </li>
